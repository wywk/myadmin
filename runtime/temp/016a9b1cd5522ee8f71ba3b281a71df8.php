<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:92:"D:\phpstudy\PHPTutorial\WWW\bschthinkphp\public/../application/admin\view\article\index.html";i:1555666454;s:75:"D:\phpstudy\PHPTutorial\WWW\bschthinkphp\application\admin\view\layout.html";i:1555490212;s:82:"D:\phpstudy\PHPTutorial\WWW\bschthinkphp\application\admin\view\public\header.html";i:1555490213;s:82:"D:\phpstudy\PHPTutorial\WWW\bschthinkphp\application\admin\view\public\footer.html";i:1555924200;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn" >
<head>
...
<table lay-filter="demo" id="demo" class="layui-table" lay-data="{id: 'js-table', height: 'full-150', cellMinWidth: 200, page: true, limit:20, url:'<?php echo url('Article/index'); ?>',limits:[20, 40, 60, 80, 100],defaultToolbar:['filter'],toolbar: '#toolbarDemo',text: {none: '暂无相关数据'}}">
    <thead>
    <tr>
        ...
        <th lay-data="{field:'name', width:200}">标题</th>
        <th lay-data="{field:'cate_id', width:200}">分类</th>
        <th lay-data="{field:'format_status', width:200, templet: '#switchTpl', unresize: true}">分类状态</th>
...
<script type="text/html" id="operation">
    <a class="layui-btn layui-btn-xs j-edit" data-href="/admin/Article/edit" lay-event="edit" >编辑</a>
