<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:94:"D:\phpstudy\PHPTutorial\WWW\bschthinkphp\public/../application/admin\view\admin_menu\edit.html";i:1557905302;s:75:"D:\phpstudy\PHPTutorial\WWW\bschthinkphp\application\admin\view\layout.html";i:1555490212;s:82:"D:\phpstudy\PHPTutorial\WWW\bschthinkphp\application\admin\view\public\header.html";i:1555490213;s:82:"D:\phpstudy\PHPTutorial\WWW\bschthinkphp\application\admin\view\public\footer.html";i:1555924200;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn" >
<head>
...
<form class="layui-form css-eidtform" id="editForm">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="input" name="name" lay-verify="title" autocomplete="off" placeholder="请输入名称" class="layui-input css-width" value="<?php echo $data['name']; ?>">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="input" name="controller" placeholder="请输入控制器" autocomplete="off" class="layui-input css-width" value="<?php echo $data['controller']; ?>">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">方法</label>
        <div class="layui-input-block">
            <input type="input" name="action" placeholder="请输入方法" autocomplete="off" class="layui-input css-width" value="<?php echo $data['action']; ?>">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">参数</label>
        <div class="layui-input-block">
            <input type="input" name="param" placeholder="请输入参数" autocomplete="off" class="layui-input css-width" value="<?php echo $data['param']; ?>">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">排序</label>
        <div class="layui-input-block">
            <input type="input" name="sort" placeholder="请输入排序" autocomplete="off" class="layui-input css-width" value="<?php echo $data['sort']; ?>">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">备注</label>
        <div class="layui-input-block">
            <input type="input" name="remark" placeholder="请输入备注" autocomplete="off" class="layui-input css-width" value="<?php echo $data['remark']; ?>">
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
