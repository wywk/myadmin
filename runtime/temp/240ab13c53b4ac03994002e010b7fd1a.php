<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:94:"D:\phpstudy\PHPTutorial\WWW\bschthinkphp\public/../application/admin\view\admin_user\edit.html";i:1557478357;s:75:"D:\phpstudy\PHPTutorial\WWW\bschthinkphp\application\admin\view\layout.html";i:1555490212;s:82:"D:\phpstudy\PHPTutorial\WWW\bschthinkphp\application\admin\view\public\header.html";i:1555490213;s:82:"D:\phpstudy\PHPTutorial\WWW\bschthinkphp\application\admin\view\public\footer.html";i:1555924200;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn" >
<head>
...
<form class="layui-form css-eidtform" id="editForm">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="input" name="name" lay-verify="title" autocomplete="off" placeholder="请输入账号名称" class="layui-input css-width" value="<?php echo $data['name']; ?>">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">手机号码</label>
        <div class="layui-input-block">
            <input type="input" name="phone" placeholder="请输入手机号码" autocomplete="off" class="layui-input css-width" value="<?php echo $data['phone']; ?>">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">座机号码</label>
        <div class="layui-input-block">
            <input type="input" name="telephone" placeholder="请输入座机号码" autocomplete="off" class="layui-input css-width" value="<?php echo $data['telephone']; ?>">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">账号状态</label>
        <div class="layui-input-block">
            <input type="checkbox" name="open" lay-skin="switch" lay-filter="switchTest" lay-text="启用|停用" <?php echo $data['status']==1?'checked' : ''; ?>>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <?php foreach($roleData as $key=>$value): ?>
                <input type="checkbox" name="role" title="<?php echo $value['name']; ?>" lay-filter="role" <?php if(in_array($value['id'], $roleIds)): ?>checked<?php endif; ?> value="<?php echo $value['id']; ?>" lay-skin="primary">
            <?php endforeach; ?>
            <input type="hidden" name="role_ids" id="role_ids" value="<?php echo $data['role_ids']; ?>">
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
            ...
            <button type="reset" class="layui-btn layui-btn-primary" onclick="editBankUrl('/admin/admin_user/index')">返回</button>
        </div>
    </div>
</form>
