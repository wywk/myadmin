<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:89:"D:\phpstudy\PHPTutorial\WWW\bschthinkphp\public/../application/admin\view\store\edit.html";i:1557474653;s:75:"D:\phpstudy\PHPTutorial\WWW\bschthinkphp\application\admin\view\layout.html";i:1555490212;s:82:"D:\phpstudy\PHPTutorial\WWW\bschthinkphp\application\admin\view\public\header.html";i:1555490213;s:82:"D:\phpstudy\PHPTutorial\WWW\bschthinkphp\application\admin\view\public\footer.html";i:1555924200;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn" >
<head>
...
<form class="layui-form css-eidtform" id="editForm">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="name" value="<?php echo $info['name']; ?>" lay-verify="" autocomplete="" placeholder="请输入昵称" class="layui-input">
        ...
        <div class="layui-form-item">
            ...
            <!--<div class="layui-input-inline">-->
                <input type="hidden" name="logo_path" lay-verify="" id="LAY_avatarSrc" placeholder="图片地址" value="<?php echo $info['logo_path']; ?>" class="layui-input">
            <!--</div>-->
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <img class="layui-upload-img" id="demo1" src="<?php echo $info['logo_path']; ?>">
                <p id="demoText"></p>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="link_man" value="<?php echo $info['link_man']; ?>" lay-verify="link_man" autocomplete="off" placeholder="请输入联系人" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">联系电话</label>
            <div class="layui-input-block">
                <input type="text" name="link_tel" value="<?php echo $info['link_tel']; ?>" lay-verify="link_tel" autocomplete="off" placeholder="请输入联系电话" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="open_time" class="layui-input" id="inputTime" placeholder=" - " readonly value="<?php echo $info['open_time']; ?>">
                </div>
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <!--<div class="layui-form-item layui-form-pane">-->
            <!--<label class="layui-form-label">城市联动</label>-->
            <div class="layui-input-inline" >
                <select name="province" lay-verify="" lay-search="" lay-skin="select" lay-filter="province" >
        ...
        <!--<div class="layui-form-item">-->
            ...
            <!--<div class="layui-input-block">-->
                <!--<input type="text" name="addr" value="<?php echo $info['address']; ?>" lay-verify="link_man" autocomplete="off" placeholder="请输入联系人" class="layui-input">-->
            <!--</div>-->
        <!--</div>-->
        <!--<div class="layui-form-item">-->
            <!--<div class="layui-inline">-->
                ...
                <!--<div class="layui-input-inline" style="width: 100px;">-->
                    <!--<input type="text" name="y_line" placeholder="经度" id ='latitude' autocomplete="off" class="layui-input" value="<?php echo $info['longitude']; ?>">-->
                <!--</div>-->
                <!--<div class="layui-form-mid">-</div>-->
                <!--<div class="layui-input-inline" style="width: 100px;">-->
                    <!--<input type="text" name="x_line" placeholder="纬度" id="longitude" autocomplete="off" class="layui-input" value="<?php echo $info['latitude']; ?>">-->
                <!--</div>-->
            <!--</div>-->
        <!--</div>-->
        <!--<div class="layui-form-item">-->
            <!--<label class="layui-form-label">地址查看</label>-->
            <!--<div class="layui-input-block">-->
                    <!--<input type="text" id="suggestId" size="20" name="addr_detail" value="" class="layui-input"/>-->
        ...
        <!--<div class="layui-form-item">-->
            <!--<label class="layui-form-label"></label>-->
            <!--<div class="layui-inline">-->
                <!--<div style="width:697px;height:450px;border:#ccc solid 1px;" id="allmap"></div>-->
            <!--</div>-->
        <!--</div>-->
        <div class="layui-form-item">
            <label class="layui-form-label">详细地地址</label>
            <div class="layui-input-block">
                <input type="text" name="addr" value="<?php echo $info['address']; ?>" lay-verify="link_man" autocomplete="off"  id="addr_cur"  placeholder="请输入详细地址" class="layui-input css-width">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">坐标地址</label>
            <div class="layui-input-block">
                <input type="text" name="tude" value="<?php echo $info['longitude']; ?>,<?php echo $info['latitude']; ?>" lay-verify="link_man" autocomplete="off" placeholder="经纬度" id="poi_cur" readonly class="layui-input css-width">
                <!--<div class="layui-input-inline">-->
                    <!--<input type="text" name="" value="" lay-verify="link_man" autocomplete="off" placeholder="详细地址" id="addr_cur" readonly class="layui-input">-->
                <!--</div>-->
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="radio" name="status" value="1" title="启用" <?php if($info['status'] == 1): ?> checked <?php endif; ?> checked="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <textarea name="brief" placeholder="" class="layui-textarea"><?php echo $info['desc']; ?></textarea>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="sort" value="<?php echo $info['sort']; ?>" lay-verify="link_man" autocomplete="off" placeholder="请输入联系人" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button class="layui-btn"  lay-submit="" lay-filter="setmyinfo">确认修改</button>
                <button type="reset" class="layui-btn layui-btn-primary" onclick="editBankUrl('/admin/store/index')">返回</button>
            </div>
        </div>
    </form>
