<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:95:"D:\phpstudy\PHPTutorial\WWW\bschthinkphp\public/../application/admin\view\admin_menu\index.html";i:1557905302;s:75:"D:\phpstudy\PHPTutorial\WWW\bschthinkphp\application\admin\view\layout.html";i:1555490212;s:82:"D:\phpstudy\PHPTutorial\WWW\bschthinkphp\application\admin\view\public\header.html";i:1555490213;s:82:"D:\phpstudy\PHPTutorial\WWW\bschthinkphp\application\admin\view\public\footer.html";i:1555924200;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn" >
<head>
...
<body>
    ...
    <table lay-filter="demo" id="demo" class="layui-table" lay-data="{id: 'js-table', height: 'full-150', cellMinWidth: 200, page: true, limit:20, url:'<?php echo url('AdminMenu/index'); ?>',limits:[20, 40, 60, 80, 100],defaultToolbar: ['filter'], toolbar: '#toolbarDemo',text: {none: '暂无相关数据'}}">
    <thead>
    <tr>
        <th lay-data="{field:'title_show', width:400}">菜单名称</th>
        <th lay-data="{field:'controller', width:200}">控制器</th>
        <th lay-data="{field:'action', width:200}">方法</th>
...
<script type="text/html" id="toolbarDemo">
    <div class="layui-btn-container">
        <?php if(isset($authMenu['addButton'])): ?><?php echo $authMenu['addButton']; endif; ?>
    </div>
</script>
<script type="text/html" id="operation">
    <?php if(isset($authMenu['editButton'])): ?><?php echo $authMenu['editButton']; endif; if(isset($authMenu['dropButton'])): ?><?php echo $authMenu['dropButton']; endif; if(isset($authMenu['dropButton'])): ?><?php echo $authMenu['dropButton']; endif; ?>
</script>
