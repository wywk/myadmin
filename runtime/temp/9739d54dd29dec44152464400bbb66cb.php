<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:95:"D:\phpstudy\PHPTutorial\WWW\bschthinkphp\public/../application/admin\view\store_role\index.html";i:1557280753;s:75:"D:\phpstudy\PHPTutorial\WWW\bschthinkphp\application\admin\view\layout.html";i:1555490212;s:82:"D:\phpstudy\PHPTutorial\WWW\bschthinkphp\application\admin\view\public\header.html";i:1555490213;s:82:"D:\phpstudy\PHPTutorial\WWW\bschthinkphp\application\admin\view\public\footer.html";i:1555924200;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn" >
<head>
...
<body>
    ...
    <table lay-filter="demo" id="demo" class="layui-table" lay-data="{id: 'js-table', height: 'full-150', cellMinWidth: 200, page: true, limit:20, url:'<?php echo url('StoreRole/index'); ?>',limits:[20, 40, 60, 80, 100],defaultToolbar: ['filter'], toolbar: '#toolbarDemo',text: {none: '暂无相关数据'}}">
    <thead>
    <tr>
        <th lay-data="{field:'title_show', width:400}">角色名称</th>
        <th lay-data="{field:'format_store_name', width:400}">所属门店</th>
...
<script type="text/html" id="switchTpl">
    <input type="checkbox" name="status" lay-skin="switch" data-id="{{d.id}}" lay-text="启用|停用" lay-filter="statusDemo" {{ d.status == 1 ? 'checked' : '' }}>
</script>
...
<script type="text/html" id="operation">
    <a class="layui-btn layui-btn-xs j-edit" data-href="/admin/store_role/edit" lay-event="edit">编辑</a>
    <a class="layui-btn layui-btn-xs j-menu" data-href="/admin/store_role/setMenu" lay-event="menu">分配权限</a>
