<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:98:"D:\phpstudy\PHPTutorial\WWW\bschthinkphp\public/../application/admin\view\admin_role\set_menu.html";i:1555924200;s:75:"D:\phpstudy\PHPTutorial\WWW\bschthinkphp\application\admin\view\layout.html";i:1555490212;s:82:"D:\phpstudy\PHPTutorial\WWW\bschthinkphp\application\admin\view\public\header.html";i:1555490213;s:82:"D:\phpstudy\PHPTutorial\WWW\bschthinkphp\application\admin\view\public\footer.html";i:1555924200;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn" >
<head>
...
<div class="layui-row container">
    <div class="main-content">
        <input value="<?php echo $id; ?>" name="id" class="role_id" type="hidden">
        <table class="layui-table">
            ...
            <?php foreach($data as $key=>$vo): ?>
                <tr>
                    <td class="listTitle">
                        ...
                        <span class="faCheckBox <?php if(in_array($vo['id'],$meun_ids)): ?> checkClass <?php endif; ?>" data-id="<?php echo $vo['id']; ?>"></span>
                    </td>
                    <td class="listContent">
                        <ul>
                            <?php foreach($vo['child'] as $k=>$v): ?>
                            <li>
                                <span class="checkBox <?php if(in_array($v['id'],$meun_ids)): ?> checkClass <?php endif; ?>" data-id="<?php echo $v['id']; ?>"></span>
            ...
            <tr>
                <td class="listTitle">
                    ...
                    <span class="allCheckBox"></span>
                </td>
                <td class="listContent allCheckCon">
                    <ul >
                        <li>
                            <button class="allCkButton submitButton">提 交</button>
                            <button class="allCkBack" onclick="editBankUrl('/admin/admin_role/index')">返 回</button>
                        </li>
                    </ul>
                </td>
            </tr>
