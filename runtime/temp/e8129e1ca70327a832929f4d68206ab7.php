<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:90:"D:\phpstudy\PHPTutorial\WWW\bschthinkphp\public/../application/admin\view\article\add.html";i:1555666454;s:75:"D:\phpstudy\PHPTutorial\WWW\bschthinkphp\application\admin\view\layout.html";i:1555490212;s:82:"D:\phpstudy\PHPTutorial\WWW\bschthinkphp\application\admin\view\public\header.html";i:1555490213;s:82:"D:\phpstudy\PHPTutorial\WWW\bschthinkphp\application\admin\view\public\footer.html";i:1555924200;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn" >
<head>
...
<form class="layui-form css-eidtform" id="editForm">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="input" name="name" lay-verify="name" autocomplete="off" placeholder="请输入文章名称" class="layui-input css-width">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <textarea id="demo" name="content" style="display: block;"></textarea>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
